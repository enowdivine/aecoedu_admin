...
import { updatePartner } from "../../app/reducers/app";

function UpdatePartnerModalBody({ closeModal, extraObject }) {
  ...
  const updateHandler = async () => {
    if (title && link && desc) {
      ...
      await dispatch(updatePartner(data)).then((res) => {
...
export default UpdatePartnerModalBody;
